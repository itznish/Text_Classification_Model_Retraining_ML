...
# In[1]:
#main_file = 'E:\DOCS\bakup\python_automation_code_package\Naive_Bayes_Classifer_main_training_file_test_CLEANED.py'
...
#Keywords file
Section_keywords = pd.read_excel(""E:\DOCS\bakup\freyr\python_automation_code_package\ML Resources\M3_Keywords_32S_individual_words_32S7")  #Keywords filepath
...
import pickle
model_path = "E:\DOCS\bakup\freyr\python_automation_code_package\Trained_Models\" #Model_filepath
vocab = "E:\DOCS\bakup\freyr\python_automation_code_package\Trained_Models\"      #Vocabulary_filepath
...
Retraining_data_path = "E:\DOCS\bakup\freyr\python_automation_code_package\Retraining"  #Retraining data directory path
...
import glob
retrain_data = [pd.read_excel(file,index_col=[0]) for file in glob.glob(Retraining_data_path)]  #Collecting all training data from excel files
...
os.system("python "E:\\DOCS\\bakup\\freyr\\python_automation_code_package\\Naive_Bayes_Classifer_main_training_file_test.py"") #Specify Main code filepath
