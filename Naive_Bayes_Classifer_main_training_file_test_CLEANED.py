...
#Exporting to excel
# pd.DataFrame(file_content).to_excel("")  #Export to excel file to create training data (specify path) first time run only
...
#Geo-words
geo_words = pd.read_excel("")  #Geo specific stopwords filepath
...
root_path = "" #Rootpath for storing vocabulary
...
filename = "save-model-file-path" + "NB_Model_" + str(rand_num_model) + ".mdl"   #Specify path to save the trained model file
#print(filename)
